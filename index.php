...
<head>
    ...
    <!-- Webpage Title -->
    <title>Aagami Negotiation Engine</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title"> Everything documented</h4>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">next gen chat interface</h4>
                        </div>
                    </div>
                    <!-- end of card -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a class="btn-outline-lg page-scroll" href="login.php">Get strarted with us</a>
                </div>
                <!-- end of col -->
            </div>
            <!-- end of row -->
